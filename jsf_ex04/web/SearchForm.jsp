...
<f:view>
    ...
    <h:form>
        ...
        <table>
            <tr>
                <td colspan="4">Where and when do you want to travel?</td>
            </tr>
            <tr>
